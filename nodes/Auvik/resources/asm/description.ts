...
export const asmFields: INodeProperties[] = [
  ...
  { displayName: 'Query Date Preset', name: 'queryDatePreset', type: 'options', default: 'LAST_30_DAYS', options: [...dateTimePresetOptions, { name: 'Custom', value: 'CUSTOM' }], displayOptions: { show: { resource: ['asm'], operation: ['getApps', 'getClients', 'getSecurityLogs'] } } },
