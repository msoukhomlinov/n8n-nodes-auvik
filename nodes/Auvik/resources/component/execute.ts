...
export async function executeComponent(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
  ...
  if (operation === 'getMany') {
    ...
    const data = await getAllByCursor.call(this, { path: '/inventory/component/info', qs });
  ...
  if (operation === 'getOne') {
    ...
    const resp = await requestAuvik.call(this, { method: 'GET', path: `/inventory/component/info/${encodeURIComponent(id)}` });
